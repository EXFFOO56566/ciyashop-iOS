...
//            return view.bounds.height - view.safeAreaLayoutGuide.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor)
//        }else{
...
internal class WWClock: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if time.hour < 12 {
            ...
            var str = NSAttributedString(string: "AM", attributes: [NSAttributedString.Key.font: fontAMPMHighlight ?? UIFont.systemFont(ofSize: 20), NSAttributedString.Key.foregroundColor: fontColorAMPMHighlight ?? UIColor.white, NSAttributedString.Key.paragraphStyle: paragraph])
